...
public abstract class EfReadOnlyRepository<TEntity> : IReadOnlyRepository<TEntity> where TEntity : Entity
{
    ...
    public virtual IQueryable<TEntity> All() => _dbSet.AsNoTracking();
    ...
    {
        return All(x => x, predicate, orderBy, include, ignoreQueryFilters);
    ...
    public virtual async Task<IList<TEntity>> AllAsync(CancellationToken cancellationToken = default) => await _dbSet.AsNoTracking().ToListAsync(cancellationToken);
    ...
    {
        return await AllAsync(x => x, predicate, orderBy, include, ignoreQueryFilters, cancellationToken);
    }
    ...
    public IPagedList<TEntity> GetPagedList(Expression<Func<TEntity, bool>>? predicate = null,
                                     ...
                                     bool ignoreQueryFilters = false)
    {
        return GetPagedList(x => x, predicate, orderBy, include, pageSize, pageSize, ignoreQueryFilters);
    }
    ...
    public async Task<IPagedList<TEntity>> GetPagedListAsync(Expression<Func<TEntity, bool>>? predicate = null,
                                                ...
                                                CancellationToken cancellationToken = default)
    {
        return await GetPagedListAsync(x => x, predicate, orderBy, include, pageIndex, pageSize, ignoreQueryFilters, cancellationToken);
    }
    ...
    public TEntity? FirstOrDefault(Expression<Func<TEntity, bool>>? predicate = null,
                              ...
                              bool ignoreQueryFilters = false)
    {
        return FirstOrDefault<TEntity>(x => x, predicate, orderBy, include, ignoreQueryFilters);
    }
    ...
    public async Task<TEntity?> FirstOrDefaultAsync(Expression<Func<TEntity, bool>>? predicate = null,
        ...
        CancellationToken cancellationToken = default)
    {
        return await FirstOrDefaultAsync<TEntity>(x => x, predicate, orderBy, include, ignoreQueryFilters, cancellationToken);
    }
