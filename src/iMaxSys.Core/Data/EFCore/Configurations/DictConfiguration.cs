...
/// Dictionary映射配置
/// </summary>
public class DictCatalogConfiguration : TenantMasterEntityConfiguration<Dict>
{
    protected override void Configures(EntityTypeBuilder<Dict> builder)
    {
        //基类配置
        ...
        //数据类型
        builder.Property(x => x.DataType).HasColumnName("data_type").HasComment("数据类型");
        //value
        ...
        //XppId
        builder.Property(x => x.XppId).HasColumnName("xpp_id").HasComment("XppId");
        //状态
