...
namespace iMaxSys.Identity
{
    ...
    {
        public MenuService(IMapper mapper, IOptions<MaxOption> option, IIdentityCache cache, IUnitOfWork<MaxIdentityContext> unitOfWork) : base(mapper, option, cache, unitOfWork)
        {
        }
