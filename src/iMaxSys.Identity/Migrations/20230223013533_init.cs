        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    open_id = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    session_key = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    selected_icon = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true, comment: "SelectedIcon")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    server_router = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true, comment: "ServerRouter")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    client_router = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true, comment: "ClientRouter")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ext = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: true, comment: "Ext")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    status = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    referrer_id = table.Column<long>(type: "bigint", nullable: false, comment: "推荐人Id"),
                    ...
                    last_ip = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false, comment: "最后登录IP")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    error_count = table.Column<int>(type: "int", nullable: false, comment: "错误次数"),
                    is_locked = table.Column<bool>(type: "tinyint(1)", nullable: false, comment: "是否锁定"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tenant_menu", x => x.id);
                    table.ForeignKey(
                        name: "FK_tenant_menu_menu_menu_id",
                        column: x => x.menu_id,
                        principalTable: "menu",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tenant_menu_menu_id",
                table: "tenant_menu",
                column: "menu_id");

            migrationBuilder.CreateIndex(
                name: "IX_tenant_menu_tenant_id",
                table: "tenant_menu",
                column: "tenant_id");
        }
